...
class NPC {
  ...
  public:
    ...
    virtual void OnTransitionTaken(class IPlayer *, const std::string &, 
        const std::string &);
    virtual bool CanUse(class IPlayer *);
...
class Player : public Actor, public IPlayer {
  ...
  public:
    ...
    void SetInitialQuestStates(const class std::map<std::string, QuestStateInfo, std::less<std::string>, std::allocator<std::pair<std::string const, QuestStateInfo> > > &, 
        const std::string &);
    void SetInitialItemState(const class std::map<std::string, ItemCountInfo, std::less<std::string>, std::allocator<std::pair<std::string const, ItemCountInfo> > > &, 
        const class std::vector<std::string, std::allocator<std::string> > &, uint8_t);
